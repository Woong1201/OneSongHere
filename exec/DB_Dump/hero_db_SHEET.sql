...
CREATE TABLE `SHEET` (
  ...
  `SHEET_MATRIX` text,
  `SHEET_TITLE` varchar(30) DEFAULT NULL,
  `USER_ID` int unsigned DEFAULT NULL,
  PRIMARY KEY (`SHEET_ID`),
  KEY `FK88ss4tkw1gt5ch6ot4gn3dmxd` (`USER_ID`),
  CONSTRAINT `FK88ss4tkw1gt5ch6ot4gn3dmxd` FOREIGN KEY (`USER_ID`) REFERENCES `USER` (`USER_ID`)
