...
import AlbumImg from 'assets/images/guide/album.png';
import RankImg from 'assets/images/guide/rank.png';
...
const StudioPage = () => {
  return (
    <div className="album-page">
      ...
      <img src={AlbumImg} alt="img" className="album-page__img" />
      <p className="album-page__list">
        앨범 커버에 마우스를 올리면 재생 버튼이 나타나며, 이를 클릭하여 곡을
        재생할 수 있습니다. 사용자는 자신이 좋아하는 앨범에 &apos;좋아요&apos;를
        표시할 수 있습니다.
      </p>
      <img src={RankImg} alt="img" className="album-page__img" />
      <p className="album-page__list">
